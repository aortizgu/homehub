...
void PeripheralDevice::getTemp(
        std::function<void(bool error, double temp)> cb) {
...
void PeripheralDevice::getUpTime(
        std::function<void(bool error, const std::string &uptime)> cb) {
